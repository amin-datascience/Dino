...
class MultiCropWrapper(nn.Module):
	...
	def forward(self, x):
		...
		chunks = cls_token.chunk(n_crops) #List: n_crops, (n_samples, out_dim)
...
class DataAugmentation(object):
	...
	def __init__(self, global_crops_scale = (0.4, 1), local_crops_scale = (0.4, 0.9), n_local_crops = 8, size = 32):
